                                            ...
                                            while($result=mysqli_fetch_assoc($queryclubs)){
                                                echo '
                                                                ...
                                                                <div class="col-md-4 py-3 py-md-0">
                                                                        <div class="card">
                                                                            <div class="edit-items">
                                                                                <img src="./assets/Clubs/creative-woman-lady-girl-model-shine-blue-green-orange-colors-new-bright-conceptual-art-make-up-glows-under-ultraviolet-light-108934495.jpg" alt="" class="card2 image-top" height="200px" style="width: 100%;">
