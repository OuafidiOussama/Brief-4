                            ...
                            <div class="col-md-4 py-3 py-md-0">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="btn2" class="text-center">30-07-2022</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card1">
                <div class="card-content">
                    ...
                    <div class="card-detail">
                        <span>CLUB NAME</span>
                        <a href="#" class="club-edit"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="#" class="club-edit"><i class="fa-solid fa-trash"></i></a>
