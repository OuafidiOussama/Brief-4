...
<body>
                                                ...
                                                while($result=mysqli_fetch_assoc($queryclubs)){
                                                    echo '
                                                                    <div class="col-md-4 py-3 py-md-0" >
                                                                            <div class="card" style="margin-top: 40px;">
                                                                                <div class="edit-items">
                                                                                    <img src="./assets/Clubs/creative-woman-lady-girl-model-shine-blue-green-orange-colors-new-bright-conceptual-art-make-up-glows-under-ultraviolet-light-108934495.jpg" alt="" class="card image-top" height="200px" style="width: 100%;">
                                                                                    <a id='.$result["idclubs"].'"><i class="fa-solid fa-pen-to-square event-update"></i></a>
    ...
    <div class="add-club hide">
        ...
        <div class="content">
            <div class="card1">
                <div class="card-content">
                    <H3 class="text-center">ADD A NEW CLUB</H3>
                    <div class="backgroundimg">
                        <img src="./assets/images/logo-youcode-ma.png" alt="">
                    </div>
                    ...
                    <div class="image">
                        <a id="add-club-logo"><img src="./assets/images/imgbin_computer-icons-plus-sign-png.png" alt=""></a>
                    </div>
                    <div class="card-detail">
                        <span><input name="Club_Name" type="text" class="feedback-input" placeholder=" Club Name" /></span>
                        <span><input name="Date_Of_Creation" type="date" class="feedback-input"/></span>
